...
<ul>
<li>Register the business with the Accounting 7 Corporate Regulatory Authority (ACRA).</li>
...
<li>The latest set of management accounts (both Balance Sheet and Profit 7 Loss Statement) will be required for business entities incorporated for more than 18 months including entities with dormant status.
<ul>
