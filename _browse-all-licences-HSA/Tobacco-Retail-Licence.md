...
<p>The outlet can only retail tobacco products upon the successful change in status of the application to &ldquo;Approved&rdquo; with the issuance of the licence number. The licence number can be obtained from our HSA website:<a href="http://eservice.hsa.gov.sg/prism/common/enquirepublic/SearchTRURetail.do?action=load" target="_blank" rel="noopener">http://eservice.hsa.gov.sg/prism/common/enquirepublic/SearchTRURetail.do?action=load</a></p>
<p>After the change in the status of the application to &ldquo;Approved&rdquo;, the electronic copy of the licence will be made available in the GoBusiness Licensing website, under the tab &ldquo;Licences&rdquo; for download.</p>
