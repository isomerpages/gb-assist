...
<p>1. What are the requirements to apply for an ODVL?</p>
<p>All Omnibus Drivers (Singaporean, Singapore Permanent Resident (SPR) and Foreign Work Pass Holders(FWP)) must be hired by the Public Transport Operator (PTO) before they are eligible to apply for Omnibus Driver's Vocational Licence (ODVL).</p>
<p>2. Who are the Public Transport Operators?</p>
<p>These are the list of Public Transport Operators:</p>
<ul>
...
<li>As Singapore Permanent Resident (SPR),
<ul>
<li>Holds a valid class 3/3A Singapore driving licence for at least a continuous period of one year at the point of application;</li>
<li>Pass LTA's required medical examination and background checks;</li>
</ul>
</li>
<li>As Foreign Work Pass (FWP) holder,
<ul>
...
<p>4. How do I apply for an ODVL?</p>
<p>Only PTOs can submit ODVL application on behalf of applicant via GoBusiness through CorpPass. PTOs are required to pay a non-refundable application fee of $40 per applicant, upon submitting the online application. All supporting documents must be uploaded online:</p>
<ul>
...
<p>You may go to any registered medical clinic to have your chest x-ray and medical examinations done for the purpose of your ODVL application.<br />You will be required to use LTA's medical examination form at<a target="" rel="">https://www.onemotoring.com.sg/content/dam/onemotoring/Forms/VL_Medical_Form.pdf</a>.</p>
...
<p>8. What are the medical requirements to apply for an ODVL?</p>
...
<tr>
<td>Age Range</td>
<td>Frequency of Medical Examination</td>
</tr>
<tr>
<td>50 - 64 years</td>
...
<p>However, ODVL holders aged 65 years and above will have to pass LTA's yearly medical examination in order to continue to hold the licence.</p>
<p>9. How long can an applicant expect to wait for his application to LTA to be approved?</p>
<p>As a general guide, it will take about 30 working days for LTA to process an application for an ODVL, assuming that all relevant documents have been duly submitted.</p>
<p>10. Will non-Singapore Citizens (SPR / FWP holder) be allowed to apply for an ODVL?</p>
<p>Yes, there is no Citizenship restrictions on who can apply for an ODVL. However, employment letter as proof of being an employee driving for a PTO as a bus captain is required for FWP.</p>
<p>11. Can I apply for an ODVL if I have an offence?</p>
<p>Please do not apply for a vocational licence if:</p>
<ul>
...
<p>13. How can I know more about ODVL Course?</p>
...
<ul>
<li>(a) Hazard Awareness Training and Test</li>
<li>(b) Scenario-based Simulator Training</li>
</ul>
</li>
</ul>
<p>15. Are there tests for the ODVL? Why is there a need?</p>
<p>ODVL course applicants will be required to attend training and pass the relevant tests in order to obtain the licence. This is to ensure that they are equipped with knowledge on traffic rules and regulations, service quality as well as general safety and route.</p>
<p>16. Can I re-sit for the ODVL test if I am unable to pass on my first attempt?</p>
<p>Yes, ODVL applicants can liaise directly with the PTO to arrange for re-test.</p>
<p>17. What is the validity of an ODVL?</p>
<p>ODVL is valid for lifetime from the date of issuance till licensees leave the PTO. This is applicable for Singaporean and Singapore Permanent Resident. Foreign Work Permit Holders will need to re-apply if they leave their current PTO.</p>
<p>18. Will ODVL holders be required to go for refresher courses?</p>
<p>SGBA will progressively introduce refresher courses and advanced-level modules for existing bus captains to undergo continual training and skills upgrading.</p>
<p>19. Can Skills Future Credit be used for ODVL course?</p>
<p>Yes.</p>
...
<p>22. What must I do if my ODVL is lost or damaged?</p>
<p>You are required to make a police report immediately and apply for a duplicate licence at LTA, 10 Sin Ming Drive with the following documents:</p>
<ul>
<li>A recent passport photograph</li>
<li>Original NRIC / Work permit (Original Passport &ndash; if NRIC is not available);</li>
<li>Valid Class 3/3A/3C/3CA Driving Licence;</li>
<li>Original police report stating the loss of the ODVL licence;</li>
<li>Letter of employment from PTO; and</li>
...
<p><strong>NRIC - Front and Back</strong></p>
<p>For Singaporean / SPR: NRIC<br />Mandatory to upload upon application for all type of vocational licences.</p>
<p><strong>Employment Pass / S Pass / Work Permit / In-principle approval letter by MOM stating Name, FIN, Occupation (must be "Bus Driver"), Expiry date and Company Name - Front and Back</strong></p>
<p>For Foreigner: Employment Pass / S Pass / Work Permit / In-principle approval letter by MOM stating Name, FIN, Occupation (must be "Bus Driver"), Expiry date and Company Name<br />Mandatory to upload upon application for all type of vocational licences.</p>
