...
accordion:
  - title: Travel Management System (E-Commerce)
    content: Pytheas Ecommerce (B2C) provides an end-to-end e-commerce platform which comprises content management function to enable ease of content publish on website, dynamic packing function for bundling of flights and hotels, pricing engine to populate the latest deals from various travel agents and customer relationship management feature to consolidate customers and transaction details for easy retrieval of information across different travel agencies. <br/><br/><a href='/productivity-solutions-grant/solutionrepo/solution706' target='_blank' style='color:#037e8a'>Pytheas Ecommerce (B2C) Version 1.1</a><br/>
---
