...
<p></p>
<p>c) For Pte Ltd, Company's/Director's Resolution (Tenant/Owner)</p>
<p></p>
<p>d) Copy of (Sub)Tenant'/Occupiers' Work Permits*/Employment Pass/S Pass/Student Pass/Dependant's Pass with validity of at least 6 months. (to be produced upon request by HDB)</p>
<p></p>
...
<tr>
<td valign="top">
<p>Renting Out Part of<br />(Trading Area) - New Application / Change of (Sub)Tenant</p>
<p></p>
</td>
<td>
...
<p>There is no prescribed format. 3rd party Authorisation Letter refers to authorisation letter from the existing or proposedtenant for 3rd party filing e.g. agent / representative or proposed (sub)tenant who is submitting application on behalf of the former. For assignment application, authorisation letter from the assignee is also required for 3rd party filer.</p>
